...
//}
//
//@spatial class Simplex extends SpatialTest {
//  import Defs._
...
//    val parameter_DRAM = DRAM[OutputType](Defs.size)
//
...
//      val param_sram = SRAM[OutputType](I32(Defs.size)).fullfission
//      Parallel {
//        input_sram load input_DRAM(0 :: dimensions par I32(32))
//        param_sram load parameter_DRAM(0 :: Defs.size par I32(32))
//      }
//
...
//}
//
//@spatial class Hypercube extends SpatialTest {
//  import Defs._
//  import spatial.dsl._
//
//  def main(args: Array[String]): Unit = {
...
//        param_sram load parameter_DRAM(0 :: Defs.size par I32(8))
//      }
//
//      Foreach (iterations par 1) {
//        _ => {
